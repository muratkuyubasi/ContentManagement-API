...
namespace ContentManagement.Domain.Migrations
{
    ...
    [Migration("20231003085538_ServicesAndActivities")]
    partial class ServicesAndActivities
    {
            ...
            modelBuilder.Entity("ContentManagement.Data.FrontMenuRecord", b =>
                {
                    ...
                    b.Property<string>("FrontMenuName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ContentManagement.Data.FrontMenuRecord", b =>
                {
                    ...
                    b.HasOne("ContentManagement.Data.FrontMenuRecord", "Parent")
                        .WithMany()
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
