...
namespace ContentManagement.Domain.Migrations
{
    ...
    [Migration("20231023112702_ReplacementId")]
    partial class ReplacementId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContentManagement.Data.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContentManagement.Data.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContentManagement.Data.Dto.GenderDTO", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContentManagement.Data.Dto.UserInformationDTO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("isDualNationality")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("ContentManagement.Data.Models.Activity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContentManagement.Data.Models.Age", b =>
                {
                    ...
                    b.Property<decimal?>("EntranceFree")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("ContentManagement.Data.Models.FoundationPublication", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FoundationPublications");
                });
            ...
            modelBuilder.Entity("ContentManagement.Data.Models.MemberType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContentManagement.Data.Models.Mosque", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ExplanationAboutMosque")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ImamFullName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("LodgingCount")
                        .HasColumnType("int");

                    b.Property<string>("Name")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("OfficersCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContentManagement.Data.Models.News", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContentManagement.Data.Models.Note", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContentManagement.Data.Models.ReplacementId", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ContentManagement.Data.Models.Services", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContentManagement.Data.Models.SpouseDTO", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContentManagement.Data.City", b =>
                {
                    b.HasOne("ContentManagement.Data.Country", "Country")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("ContentManagement.Data.Dto.FamilyMemberDTO", b =>
                {
                    ...
                    b.HasOne("ContentManagement.Data.Dto.UserInformationDTO", "MemberUser")
                        .WithMany()
            ...
            modelBuilder.Entity("ContentManagement.Data.Dto.UserInformationDTO", b =>
                {
                    b.HasOne("ContentManagement.Data.Dto.GenderDTO", "Gender")
                        .WithMany()
            ...
            modelBuilder.Entity("ContentManagement.Data.FrontMenu", b =>
                {
                    ...
                    b.HasOne("ContentManagement.Data.FrontMenu", "Parent")
                        .WithMany()
            ...
            modelBuilder.Entity("ContentManagement.Data.FrontMenuRecord", b =>
                {
                    b.HasOne("ContentManagement.Data.FrontMenu", "FrontMenu")
                        .WithMany("FrontMenuRecords")
                        .HasForeignKey("FrontMenuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FrontMenu");
                });
            ...
            modelBuilder.Entity("ContentManagement.Data.Models.FamilyMember", b =>
                {
                    ...
                    b.HasOne("ContentManagement.Data.Models.MemberType", "MemberType")
                        .WithMany("FamilyMembers")
            ...
            modelBuilder.Entity("ContentManagement.Data.Models.SpouseDTO", b =>
                {
                    ...
                    b.HasOne("ContentManagement.Data.Dto.UserInformationDTO", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("ContentManagement.Data.Models.UserModel", b =>
                {
                    ...
                    b.HasOne("ContentManagement.Data.Models.SpouseDTO", "Spouse")
                        .WithMany()
